...
<html lang="fr">
	<head>
		...
		<title>Nouveau Questionnaire</title>
		...
		<script src="../js/newQuestionnaire.js" type="text/javascript"></script>		
	</head>
	<body>
		<h1 id="t"></h1>
		<h1 id="part11" class="title1">Nouveau Questionnaire</h1>
		<h1 id="part21" class="title1"></h1>
		<h1 id="part31" class="title1">Nouveau Questionnaire</h1>
		<br>
		<br>
		<div id="block1" class="container">
		  <div class="jumbotron font1">
			<h3 id="part12" class="pharag4">Souhaiteriez vous être défié sur ce questionnaire ?</h3>
			<input id= "part13" type="checkbox" name="defiable">
			<h3 id="part221" class="pharag4"></h3>
			<h3 id="part22" class="pharag4"></h3>
			<button id="contenu" type="button" class="btn btn-lg btn-primary col-lg-2 col-lg-offset-1"></button>
		  </div>
		</div>
			...
			<div id="part24" class="jumbotron font1">
				<div class="row"> 
					<div class="well col-lg-4  col-lg-offset-1 font2">
						<h4 class="pharag1">Intervalle de réponse 1 :</h4> 
						<b id="intValMin1"></b>
					...
					<div class="well col-lg-4 col-lg-offset-2 font2">
						<h4 class="pharag1">Niveau de confiance 1 :</h4>
						<input type="text" class="form-control" placeholder="100%" readonly>
					</div>
				</div>
				<div class="row">
					<div class="well col-lg-4  col-lg-offset-1 font2">
						<h4 class="pharag1">Intervalle de réponse 2 : </h4> 
						<b id="intValMin2"></b>
					...
					<div class="well col-lg-4  col-lg-offset-2 font2">
						<h4 class="pharag1">Niveau de confiance 2 :</h4>
				...
				<div class="row">
					<div class="well col-lg-4  col-lg-offset-1 font2">
						<h4 class="pharag1">Intervalle de réponse 3 :</h4> 
						<b id="intValMin3"></b>
					...
					<div class="well col-lg-4  col-lg-offset-2 font2">
						<h4 class="pharag1">Niveau de confiance 3 :</h4>
		...
		<button id="part23" type="button" class="btn btn-lg btn-primary col-lg-2 col-lg-offset-8">Next</button>
		<button id="part28" type="button" class="btn btn-lg btn-primary col-lg-2 col-lg-offset-8">Fin</button>
