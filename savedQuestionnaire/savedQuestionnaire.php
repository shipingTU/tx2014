...
<html lang="fr">
	<head>
		...
		<title>Questionnaire Enregisré</title>
		...
		<script src="../js/savedQuestionnaire.js" type="text/javascript"></script>
	</head>
	<body>
		<h1 id="t"></h1>
		<h1 id="part11" class="title1">Questionnaire existant</h1>
		<h1 id="part21" class="title1"></h1>
		<h1 id="part31" class="title1">Questionnaire existant</h1>
		<br>
		<br>
		<div id="block1" class="container">
		  <div class="jumbotron font1">
			<h3 id="part12" class="pharag4">Cliquer sur la bouton "Start" pour lancer le questionnaire.</h3>
